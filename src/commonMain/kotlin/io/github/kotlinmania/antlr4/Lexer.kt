...
abstract class Lexer :
    ...
    var _mode: Int = io.github.kotlinmania.antlr4.Lexer.Companion.DEFAULT_MODE
    ...
    open fun reset() {
        ...
        _hitEOF = false
        _mode = io.github.kotlinmania.antlr4.Lexer.Companion.DEFAULT_MODE
        _modeStack.clear()
...
// 								   " at index "+input.index());
                    ...
                    if (this.type == io.github.kotlinmania.antlr4.Lexer.Companion.SKIP) {
                        continue@outer
                    }
                } while (this.type == io.github.kotlinmania.antlr4.Lexer.Companion.MORE)
                if (_token == null) emit()
                return _token!!
            }
        } finally {
     ...
     */
    fun skip() {
        this.type = io.github.kotlinmania.antlr4.Lexer.Companion.SKIP
    }

    fun more() {
        this.type = io.github.kotlinmania.antlr4.Lexer.Companion.MORE
    }
