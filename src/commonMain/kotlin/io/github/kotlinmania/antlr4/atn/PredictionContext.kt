...
import io.github.kotlinmania.antlr4.misc.MurmurHash

abstract class PredictionContext protected constructor(
    cachedHashCode: Int,
) {
    val id: Int = io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.globalNodeCount++
    ...
    fun hasEmptyPath(): Boolean {
        ...
        return getReturnState(size() - 1) == io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.EMPTY_RETURN_STATE
    }
    ...
    fun toStrings(
        ...
        outer@ while (true) {
            ...
            while (!p.isEmpty && p != stop) {
                ...
                } else if (p.getReturnState(index) != io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.EMPTY_RETURN_STATE) {
                    if (!p.isEmpty) {
                        if (localBuffer.length > 1) {
                            // first char is '[', if more than that this isn't the first rule
                            localBuffer.append(' ')
    ...
    companion object {
        ...
        internal fun calculateEmptyHashCode(): Int {
            var hash: Int = MurmurHash.initialize(io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.INITIAL_HASH)
            ...
            if (rootIsWildcard) {
                ...
                if (a === EmptyPredictionContext.Instance) { // $ + x = [x,$]
                    val payloads =
                        intArrayOf(
                            b.returnState,
                            io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.EMPTY_RETURN_STATE,
                        )
        ...
        internal fun mergeArrays(
            ...
            while (i < a.returnStates.size && j < b.returnStates.size) {
                ...
                if (a.returnStates[i] == b.returnStates[j]) {
                    ...
                    // $+$ = $
                    val bothEmpty =
                        payload == io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.EMPTY_RETURN_STATE &&
                            a_parent == null &&
                            b_parent == null
                    val ax_ax =
        ...
        fun toDOTString(context: PredictionContext?): String? {
            ...
            for (current in nodes) {
                ...
                for (inv in arr.returnStates) {
                    if (!first) buf.append(", ")
                    if (inv == io.github.kotlinmania.antlr4.atn.PredictionContext.Companion.EMPTY_RETURN_STATE) {
                        buf.append("$")
                    } else {
                        buf.append(inv)
                    }
