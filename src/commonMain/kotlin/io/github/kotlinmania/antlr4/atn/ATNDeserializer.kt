...
import io.github.kotlinmania.antlr4.misc.IntList
...
class ATNDeserializer
    ...
    constructor(
        ...
        fun deserialize(data: IntArray): ATN {
            var p = 0
            val version = data[p++]
            if (version != io.github.kotlinmania.antlr4.atn.ATNDeserializer.Companion.SERIALIZED_VERSION) {
                val reason: String? =
                    "Could not deserialize ATN with version $version (expected ${io.github.kotlinmania.antlr4.atn.ATNDeserializer.Companion.SERIALIZED_VERSION})."
