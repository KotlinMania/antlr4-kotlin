...
import io.github.kotlinmania.antlr4.*
import io.github.kotlinmania.antlr4.assert
import io.github.kotlinmania.antlr4.atn.ATNState.Companion.BLOCK_END
import io.github.kotlinmania.antlr4.dfa.DFA
import io.github.kotlinmania.antlr4.dfa.DFAState
import io.github.kotlinmania.antlr4.misc.BitSet
import io.github.kotlinmania.antlr4.misc.DoubleKeyMap
...
open class ParserATNSimulator internal constructor(
    ...
    open fun adaptivePredict(
        ...
        try {
            ...
            if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) {
                println(
    ...
    protected fun execATN(
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug ||
            io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.trace_atn_sim
        ) {
            println(
        ...
        while (true) { // while more work
            ...
            if (D.requiresFullContext && mode != PredictionMode.SLL) {
                ...
                if (D.predicates != null) {
                    if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) println("DFA state has preds in DFA sim LL failover")
                ...
                if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.dfa_debug) {
                    println(
    ...
    open fun computeTargetState(
        ...
        val predictedAlt: Int =
            io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion
                .getUniqueAlt(reach)
...
// 			println("reach="+reach+", "+reach.conflictingAlts);
    ...
    open fun computeReachSet(
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) println("in computeReachSet, starting closure: " + closure)
        ...
        if (skippedStopStates == null && t != Token.EOF) {
            if (intermediate.size == 1) {
                ...
                reach = intermediate
            } else if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.trace_atn_sim) {
...
// 		}
    ...
    open fun evalSemanticContext(
        ...
        for (pair in predPredictions) {
            ...
            if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug ||
                io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.dfa_debug
            ) {
...
//            if ( debug ) println("added config "+configs);
        ...
        for (i in 0..<p.numberOfTransitions) {
            ...
            if (c != null) {
                ...
                if (config.state is RuleStopState) {
                    ...
                    newDepth--
                    if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) println("dips into outer ctx: " + c)
                } else {
    ...
    protected fun canDropLoopEntryEdgeInLeftRecursiveRule(config: ATNConfig): Boolean {
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.TURN_OFF_LR_LOOP_ENTRY_BRANCH_OPT) return false
        val p: ATNState = config.state
    ...
    protected fun actionTransition(
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) println("ACTION edge " + t.ruleIndex + ":" + t.actionIndex)
        return ATNConfig(config!!, t.target)
    }
    ...
    fun precedenceTransition(
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug) println("config from pred transition=" + c)
        return c
    }
    ...
    open fun reportAttemptingFullContext(
        ...
        if (io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.debug ||
            io.github.kotlinmania.antlr4.atn.ParserATNSimulator.Companion.retry_debug
        ) {
