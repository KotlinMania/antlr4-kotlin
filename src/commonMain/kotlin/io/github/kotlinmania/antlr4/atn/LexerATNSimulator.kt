...
class LexerATNSimulator(
    ...
    protected fun matchATN(input: CharStream): Int {
        val startState: ATNState = atn.modeToStartState[mode]

        if (io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.debug) {
    ...
    protected fun getExistingTargetState(
        ...
        if (s?.edges == null ||
            t < io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MIN_DFA_EDGE ||
            t > io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MAX_DFA_EDGE
        ) {
            return null
        }

        val target: DFAState? = s.edges!![t - io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MIN_DFA_EDGE]
    ...
    protected fun addDFAEdge(
        ...
        if (t < io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MIN_DFA_EDGE ||
            t > io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MAX_DFA_EDGE
        ) {
            ...
            if (fromState.edges == null) {
                ...
                fromState.edges =
                    arrayOfNulls<DFAState>(
                        io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MAX_DFA_EDGE -
                            io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MIN_DFA_EDGE +
                            1,
                    )
            }
            fromState.edges!![t - io.github.kotlinmania.antlr4.atn.LexerATNSimulator.Companion.MIN_DFA_EDGE] = q // connect
        }
    }
