...
abstract class CodePointCharStream private constructor(
    ...
    companion object {
        ...
        fun fromBuffer(codePointBuffer: CodePointBuffer): CodePointCharStream =
            io.github.kotlinmania.antlr4.CodePointCharStream.Companion
        ...
        fun fromBuffer(
            ...
            when (codePointBuffer.type) {
                CodePointBuffer.Type.BYTE -> return io.github.kotlinmania.antlr4.CodePointCharStream.CodePoint8BitCharStream(
                ...
                CodePointBuffer.Type.CHAR -> return io.github.kotlinmania.antlr4.CodePointCharStream.CodePoint16BitCharStream(
                    codePointBuffer.position(),
                    codePointBuffer.remaining(),
                    name,
                ...
                CodePointBuffer.Type.INT -> return io.github.kotlinmania.antlr4.CodePointCharStream.CodePoint32BitCharStream(
                    codePointBuffer.position(),
                    codePointBuffer.remaining(),
                    name,
