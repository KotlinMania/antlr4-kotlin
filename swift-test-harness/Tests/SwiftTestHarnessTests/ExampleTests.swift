...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Antlr4.swiftmodule/`
...
//      `import Antlr4` above would fail at compile time.
//
//   2. The static archive `libAntlr4.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Antlr4" }` and
//      `flattenPackage = "io.github.kotlinmania.antlr4"` configuration in
