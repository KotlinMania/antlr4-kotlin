...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Antlr4Runtime.swiftmodule/`
...
//      `import Antlr4Runtime` above would fail at compile time.
//
//   2. The static archive `libAntlr4Runtime.a` supplied every
...
final class Antlr4RuntimeExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Antlr4Runtime swift module imported cleanly")
    }
}
